...
(function($) {
    ...
    /* Masonry - DISABLED FOR GRID LAYOUT
     * ---------------------------------------------------- */ 
    var ssMasonryFolio = function () {
        // Masonry disabled in favor of CSS Grid layout
    ...
    * ------------------------------------------------------ */
    ...
    /* Project Filter
     * ---------------------------------------------------- */
    var ssProjectFilter = function() {
        
        var $filterBtns = $('.filter-btn');
        var $portfolioItems = $('.masonry__brick');
        ...
        $filterBtns.on('click', function(e) {
            ...
            if (filterValue === '*') {
                // Show all items
                $portfolioItems.removeClass('hide').addClass('show');
            } else {
                // Hide all items first
                $portfolioItems.addClass('hide').removeClass('show');
                
                // Show only items matching the filter
                setTimeout(function() {
                    $(filterValue).removeClass('hide').addClass('show');
                }, 200);
            }
        });
        
        // Initialize with all items visible
        $portfolioItems.addClass('show');
    };
    ...
    * ------------------------------------------------------ */
    (function ssInit() {
        ...
        ssMoveHeader();
        ssMobileMenu();
        // ssMasonryFolio(); // DISABLED - using CSS Grid instead
        ssPhotoswipe();
        ssSlickSlider();
        ssWaypoints();
        ssStatCount();
